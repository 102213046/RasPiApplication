...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <?php
        ...
        if(strcmp($name,'CY') == 0){
            echo "<li><a href='http://pm25-test.byethost3.com/raspberry/GPSPHP/admit.php'><h4>選擇使用者</h4></a></li>";
        }
    ?>
	  ...
	  <li><a target="_blank" href="https://www.facebook.com/%E4%B8%89%E5%AF%B6%E6%A9%9F-205477516547981/?ref=aymt_homepage_panel"><h4>粉絲專頁</h4></a></li>
...
<?php
    echo '綠：正常'.'&nbsp&nbsp&nbsp&nbsp'.'藍：藍芽判斷'.'&nbsp&nbsp&nbsp&nbsp'.'橘：發送簡訊<br><br>';
    echo "<div style='height:270px; width:325px; overflow:auto;'>";
